...
function cart(){
    ...
    $.ajax({
        ...
        success: (posRes) => {
            ...
            document.getElementById('totalitem').innerHTML = "Total Items Selected = " + totalitems
            document.getElementById('total').innerHTML = "Cost = "+total
            document.getElementById('gst').innerHTML = "GST  =  12%"
            document.getElementById('aftergst').innerHTML = "Total Amount = " + aftergst
